...
contract ResourceRentalMain {
    ...
    string message;
    mapping(address => string) public universities;
    ...
    function addUniversity(
        ...
        universities[_universityAddress] = _university;
    }
    ...
    //     if (universities[msg.sender] > 0) _;
    // }

    function deleteUniversity(address _address) public isBackend {
        delete universities[_address];
    }
